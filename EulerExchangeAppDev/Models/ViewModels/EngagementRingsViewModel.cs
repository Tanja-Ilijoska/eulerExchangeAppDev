...
{
    public class EngagementRingsViewModel
    {
        ...
        public virtual ICollection<EngagementRingsImageURL> EngagementRingsImageURL { get; set; }
        public int CompanyId { get; set; }
    }

    public class EngagementRingsListItem
    {
        [ScaffoldColumn(false)]
        public int Id { get; set; }
